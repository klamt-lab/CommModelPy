...
# Internal modules
from ..commodepy import Community, SingleModel, generate_community_cobra_model, redcom_fba
...
with community_model:
    redcom_fba(community_model, .99)

# Store model as SBML :D
cobra.io.write_sbml_model(community_model, "./commodepy/publication_run/commodepy_publication_sbmls_and_dG0_jsons/ecolicore2double__dG0_ARB_no_h2o_no_pi__metabolites_periplasmic_cytosolic.xml")

json_write("./commodepy/publication_run/commodepy_publication_sbmls_and_dG0_jsons/ecolicore2double__dG0_ARB_no_h2o_no_pi__metabolites_periplasmic_cytosolic.json", dG0_data_dict)
