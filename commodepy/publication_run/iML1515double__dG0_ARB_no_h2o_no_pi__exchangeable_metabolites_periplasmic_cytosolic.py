...
ecoli_model = cobra.io.read_sbml_model("./commodepy/publication_run/original_sbml_models_loaded_and_saved_by_cobrapy/iML1515_loaded_and_saved_by_cobrapy.xml")
...
cobra.io.write_sbml_model(community_model, "./commodepy/publication_run/commodepy_publication_sbmls_and_dG0_jsons/iML1515double__dG0_ARB_no_h2o_no_pi__metabolites_periplasmic_cytosolic.xml")

json_write("./commodepy/publication_run/commodepy_publication_sbmls_and_dG0_jsons/iML1515double__dG0_ARB_no_h2o_no_pi__metabolites_periplasmic_cytosolic.json", dG0_data_dict)
