...
ecoli_model = cobra.io.read_sbml_model(
    "./publication_runs/ecoli_models/original_sbml_models_in_cleaned_form/ecc2comp_loaded_and_saved_by_cobrapy_cleaned.xml"
)
...
community_model.reactions.EX_C_glc__D_exchg.lower_bound = -10
community_model.optimize()
print(community_model.summary())
community_model.reactions.EX_C_glc__D_exchg.lower_bound = -float("inf")

# Store model as SBML :D
cobra.io.write_sbml_model(
    community_model, "./publication_runs/ecoli_models/publication_sbmls_and_dG0_jsons/ecc2compDouble_model.xml")
json_write("./publication_runs/ecoli_models/publication_sbmls_and_dG0_jsons/ecc2compDouble_dG0.json", dG0_data_dict)
