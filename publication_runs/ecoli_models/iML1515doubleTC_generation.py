...
model = cobra.io.read_sbml_model("./publication_runs/ecoli_models/publication_sbmls_and_dG0_jsons/iML1515double_model.xml")
...
cobra.io.write_sbml_model(
    model, "./publication_runs/ecoli_models/publication_sbmls_and_dG0_jsons/iML1515doubleTC_model.xml")

# Write new dG0 data
dG0_data_dict = json_load("./publication_runs/ecoli_models/publication_sbmls_and_dG0_jsons/iML1515double_dG0.json")
json_write("./publication_runs/ecoli_models/publication_sbmls_and_dG0_jsons/iML1515doubleTC_dG0.json", dG0_data_dict)
