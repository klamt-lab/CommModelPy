...
# Internal modules
from ..pyredcom import Community, SingleModel, generate_community_cobra_model
...
ecoli_model = cobra.io.read_sbml_model("./pyredcom/publication_run/original_sbml_models_loaded_and_saved_by_cobrapy/ecolicore2_loaded_and_saved_by_cobrapy.xml")
...
# Separate from pyredcom: Create dG0 dictionary for ecolicore2double
...
cobra.io.write_sbml_model(community_model, "./pyredcom/publication_run/pyredcom_publication_sbmls_and_dG0_jsons/ecolicore2triple__dG0_ARB_no_h2o_no_pi__metabolites_periplasmic_cytosolic.xml")

json_write("./pyredcom/publication_run/pyredcom_publication_sbmls_and_dG0_jsons/ecolicore2triple__dG0_ARB_no_h2o_no_pi__metabolites_periplasmic_cytosolic.json", dG0_data_dict)
