...
cobra.io.write_sbml_model(community_model, "./pyredcom/publication_run/pyredcom_publication_sbmls_and_dG0_jsons/ecolicore2double__dG0_ARB_no_h2o_no_pi__metabolites_periplasmic_cytosolic.xml")

json_write("./pyredcom/publication_run/pyredcom_publication_sbmls_and_dG0_jsons/ecolicore2double__dG0_ARB_no_h2o_no_pi__metabolites_periplasmic_cytosolic.json", dG0_data_dict)
