...
"""pytest test range for pyredcom's functionalities."""
# IMPORT SECTION
# External modules
import cobra
import cobra.test
...
from .. import pyredcom


def test_pyredcom_api():
    ...
    single_model_1 = pyredcom.SingleModel(
    ...
    community_model = pyredcom.generate_community_cobra_model(community)
    print("")
    pyredcom.redcom_fba(community_model, .1)
    print("")
    pyredcom.minimal_species_redcom_fba(community_model, .1)
